        ...
        return (
            <Card key={index} className="mb-5 last:me-5 overflow-hidden rounded-xl">
                ...
                <div className="card-border card-rounded-b px-3.5 pt-5 pb-2.5">
                    <Link href="#" className="font-medium block text-mono hover:text-primary text-base leading-4 mb-2">
                        {work.title}
                    </Link>
                    <div className="text-sm text-secondary-foreground">
                        Token ID: <span className="text-sm font-medium text-foreground">{work.id}</span>
                    </div>
                </div>
            </Card>
        );
                    ...
                    <div className="flex flex-col justify-end grow">
                        <div className="flex items-center justify-between flex-wrap gap-2">
                            <div className="flex flex-col justify-end gap-0.5">
                                ...
                                <span className="text-secondary-foreground text-xs">{location}</span>
                            </div>
