    ...
    return (
        <Card>
            <CardContent className="flex flex-col items-center lg:pt-10">
                ...
                <span className="text-secondary-foreground text-sm mb-4">{description}</span>
                <div className="flex items-center gap-2.5">
                    <Link href="#">
                        <RiFacebookBoxLine size={20} className="text-secondary-foreground text-lg" />
                    </Link>
                    <Link href="#">
                        <Dribbble size={20} className="text-secondary-foreground " />
                    </Link>
                    <Link href="#">
                        <RiInstagramLine size={20} className="text-secondary-foreground text-lg" />
                    </Link>
                </div>
            </CardContent>
