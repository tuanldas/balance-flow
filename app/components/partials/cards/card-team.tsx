...
const CardTeam = ({ icon: Icon, title, description, labels, rating, team, connected }: ITeamProps) => {
            ...
            <CardContent className="grid gap-7 py-7.5">
                <div className="grid place-items-center gap-4">
                    ...
                    <div className="grid place-items-center">
                        <Link href="#" className="text-base font-medium text-mono hover:text-primary-active mb-px">
                            {title}
                        </Link>
                        <span className="text-sm text-secondary-foreground text-center">{description}</span>
                    </div>
                </div>
                <div className="grid">
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-2">
                        ...
                        <AvatarGroup group={team.group} more={team.more} className={team.className} size={team.size} />
                    </div>
                </div>
            </CardContent>
