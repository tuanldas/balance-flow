    ...
    return (
        <Card className="shadow-none w-[280px] mb-5">
            ...
            <div className="card-border card-rounded-b grid gap-1.5 px-5 py-4">
                <Link href="#" className="font-medium text-orange-400 text-sm hover:text-primary">
                    {label}
                </Link>
                <Link href="#" className="font-medium text-mono text-lg leading-6 mb-1.5 hover:text-primary">
                    {description}
                </Link>
