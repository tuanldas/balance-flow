...
const CardConnection = ({ name, info, avatar, email, team, statistics, connected }: IConnectionProps) => {
        ...
        <Card>
            <CardContent className="lg:pt-9 lg:pb-7.5">
                ...
                <div className="flex items-center justify-center gap-1.5 mb-2.5">
                    <Link href="#" className="hover:text-primary-active text-base leading-5 font-medium text-mono">
                        {name}
                    </Link>
                    <svg
                ...
                <div className="flex flex-wrap justify-center items-center gap-4 mb-7">
                    ...
                    <div className="flex items-center text-sm">
                        ...
                        <Link href="#" className="text-secondary-foreground hover:text-primary-active">
                            {email}
                        </Link>
                    </div>
                </div>
                <div className="grid justify-center gap-1.5 mb-7.5">
                    <span className="text-xs uppercase text-secondary-foreground text-center">team</span>
