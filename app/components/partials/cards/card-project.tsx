    ...
    return (
        <Card className="p-7.5">
            ...
            <div className="flex flex-col mb-3 lg:mb-6">
                <Link href="#" className="text-lg font-media/brand text-mono hover:text-primary-active mb-px">
                    {name}
                </Link>
            ...
            <Progress value={progress?.value} indicatorClassName={progress?.variant} className="h-1.5 mb-4 lg:mb-8" />
