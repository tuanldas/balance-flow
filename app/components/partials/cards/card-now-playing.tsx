    ...
    const renderItem = (statistic: INowPlayingItem, index: number) => {
        return (
            <div key={index} className="grid grid-cols-1 gap-1.5 text-center">
                ...
                <span className="text-secondary-foreground text-xs font-medium">{statistic.description}</span>
            </div>
        );
    };
            ...
            <div className="card-border card-rounded-b grid gap-6 px-5 py-3.5 mb-4.5">
                <div className="flex items-center gap-2.5">
                    ...
                    <div className="grid grid-cols-1 gap-0.5">
                        <Link href="#" className="text-mono hover:text-primary-active text-base font-semibold mb-px">
                            {title}
                        </Link>
