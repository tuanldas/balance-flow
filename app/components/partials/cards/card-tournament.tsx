            ...
            <div className="card-border card-rounded-b grid gap-6 px-5 pt-3.5 pb-3 mb-4">
                <div className="flex items-center gap-2.5">
                    ...
                    <div className="grid grid-cols-1 gap-0.5">
                        <Link href="#" className="text-mono hover:text-primary-active text-base font-medium mb-px">
                            {title}
                        </Link>
                        <time className="flex items-center gap-1.5 text-xs text-secondary-foreground">
                            <div className="rounded-full w-1.5 h-1.5 bg-destructive gap-1.5"></div> {time}
                        </time>
                    </div>
                </div>
                ...
                <div className="grid gap-1.5 mb-0.5">
                    ...
                    <div className="flex items-center place-content-between">
                        ...
                        <span className="text-muted-foreground text-xs font-medium">{progress.leftNumber} left</span>
                    </div>
                </div>
            </div>
        </Card>
