...
import { Archive, Calendar, CheckSquare, Settings, Settings2, Shield, Users } from 'lucide-react';
        ...
        <Sheet>
            ...
            <SheetContent className="p-0 sm:max-w-[500px]">
                <SheetHeader className="mb-0">
                    <h3 className="text-base font-semibold p-3 text-gray-900">Notifications</h3>
                </SheetHeader>
