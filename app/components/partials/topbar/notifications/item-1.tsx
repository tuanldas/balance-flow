...
export default function Item1({ userName, avatar, description, link, label, time, specialist, text }: ItemProps) {
            ...
            <div className="flex flex-col gap-3.5">
                ...
                <Card className="shadow-none flex flex-col gap-2.5 p-3.5 rounded-lg bg-muted/70">
                    <div className="text-sm font-semibold text-secondary-foreground mb-px">
                        ...
                        <span className="text-secondary-foreground font-medium">{text}</span>
                    </div>
