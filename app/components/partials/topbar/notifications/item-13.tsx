            ...
            <div className="flex flex-col gap-3.5 grow">
                <div className="flex flex-col gap-1">
                    <div className="text-sm font-medium mb-px">
                        ...
                        <Link href="#" className="hover:text-primary text-primary font-semibold">
                            TechSynergy
                        </Link>
                    </div>
                ...
                <Card className="shadow-none flex items-center flex-row justify-between gap-1.5 px-2.5 py-2 rounded-lg bg-muted/70">
                    <div className="flex flex-col">
                        <Link href="#" className="hover:text-primary font-medium text-mono text-xs">
                            Ronald Richards
                        </Link>
                        <Link href="#" className="hover:text-primary text-muted-foreground font-medium text-xs">
                            ronald.richards@gmail.com
                        </Link>
                    </div>

                    <Link href="#" className="hover:text-primary text-secondary-foreground font-medium text-xs">
                        Go to profile
                    </Link>
                </Card>
