        ...
        <div className="flex grow gap-2.5 px-5">
            ...
            <div className="flex flex-col gap-3.5 grow">
                ...
                <Card className="shadow-none flex items-center flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
                    ...
                    <Link href="#" className="hover:text-primary font-medium text-secondary-foreground text-xs me-1">
                        Launch_nov24.pptx
                    </Link>
                    <span className="font-medium text-muted-foreground text-xs">Edited 39 mins ago</span>
                </Card>
            </div>
        </div>
    );
