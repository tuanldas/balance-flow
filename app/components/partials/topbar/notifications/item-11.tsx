            ...
            <div className="flex flex-col gap-3.5 grow">
                ...
                <Card className="shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
                    <div className="flex items-center gap-1.5">
                        <img src={toAbsoluteUrl('/media/file-types/word.svg')} className="h-6" alt="image" />

                        <div className="flex flex-col gap-0.5">
                            <Link href="#" className="hover:text-primary font-medium text-secondary-foreground text-xs">
                                Landing-page.docx
                            </Link>
                            <span className="font-medium text-muted-foreground text-xs">1.9 MB</span>
                        </div>
                    </div>
                ...
                <Card className="shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
                    <div className="flex items-center gap-1.5">
                        <img src={toAbsoluteUrl('/media/file-types/svg.svg')} className="h-6" alt="image" />

                        <div className="flex flex-col gap-0.5">
                            <Link href="#" className="hover:text-primary font-medium text-secondary-foreground text-xs">
                                New-icon.svg
                            </Link>
                            <span className="font-medium text-muted-foreground text-xs">2.3 MB</span>
                        </div>
                    </div>
