                ...
                <Card className="shadow-none gap-1.5 py-2.5 rounded-lg bg-muted/70">
                    <div className="flex flex-col gap-2.5 px-2.5 mb-0.5">
                        ...
                        <div className="flex items-center gap-2.5">
                            <Badge size="sm" variant="warning" appearance="light" className="text-yellow-400 me-1">
                                <NotepadText /> Project
                            </Badge>
                            <Badge
                                size="sm"
                        ...
                        <div className="flex flex-col gap-2.5">
                            <div className="flex items-center gap-3">
                                <div className="flex items-center gap-0.5">
                                    <CalendarDays size={16} className="text-muted-foreground me-0.5 text-xs" />
                                    <span className="font-medium text-muted-foreground text-xs">22 April 2024</span>
                                </div>
                            ...
                            <div className="flex items-center gap-0.5">
                                ...
                                <div className="font-medium text-muted-foreground text-xs">
                                    Online
                                    <Link href="#" className="hover:text-primary text-primary font-medium">
                                        Zoom Meeting
                                    </Link>
                                </div>
                            </div>
