            ...
            <div className="flex flex-col gap-3.5">
                ...
                <Card className="shadow-none flex flex-col gap-2.5 p-3.5 rounded-lg">
                    ...
                    <div className="flex items-center gap-2.5">
                        <Badge size="sm" variant="primary" appearance="light" className="text-primary me-1 text-sm">
                            <Mail /> 26 Comments
                        </Badge>
                        <Badge size="sm" variant="secondary" className="text-muted-foreground me-1 text-sm">
                            <Heart /> 13 Likes
                        </Badge>
                    </div>
                </Card>
