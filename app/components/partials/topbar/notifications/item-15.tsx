            ...
            <div className="flex flex-col gap-3.5 grow">
                <div className="flex flex-col gap-1">
                    <div className="text-sm font-medium mb-px">
                        ...
                        <span className="text-secondary-foreground"> uploaded attachment </span>
                    </div>
                ...
                <Card className="shadow-none flex items-center justify-between flex-row gap-1.5 p-2.5 rounded-lg bg-muted/70">
                    <div className="flex items-center gap-1.5">
                        <img src={toAbsoluteUrl('/media/file-types/xls.svg')} className="h-6" alt="image" />

                        <div className="flex flex-col gap-0.5">
                            <Link href="#" className="hover:text-primary font-medium text-secondary-foreground text-xs">
                                Redesign-2024.xls
                            </Link>
                            <span className="font-medium text-muted-foreground text-xs">2.6 MB</span>
                        </div>
                    </div>
