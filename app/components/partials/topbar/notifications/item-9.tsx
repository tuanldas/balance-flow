        ...
        <div className="flex gap-2.5 px-5">
            ...
            <div className="flex flex-col gap-3.5">
                ...
                <div className="grid gap-1.5">
                    <Badge size="sm" variant="success" appearance="light" className="text-green-500 me-1 text-xs">
                        <CircleCheck /> Feature Prioritization
                    </Badge>
                    <Badge size="sm" variant="secondary" className="text-secondary-foreground me-1 text-xs">
