...
import { Calendar, CheckCheck, MoreVertical, Settings2, Shield, Upload, Users } from 'lucide-react';
            ...
            <SheetContent className="p-0 gap-0 sm:w-[450px] sm:max-w-none inset-5 start-auto h-auto rounded-lg p-0 sm:max-w-none [&_[data-slot=sheet-close]]:top-4.5 [&_[data-slot=sheet-close]]:end-5">
                    ...
                    <div className="border-b border-border p-3 shadow-xs">
                        <div className="flex items-center justify-between gap-2">
                            <div className="flex items-center gap-2">
                                ...
                                <div>
                                    <Link href="#" className="text-sm font-semibold text-mono hover:text-blue-600">
                                        HR Team
                                    </Link>
                            ...
                            <div key={index} className="flex items-end justify-end gap-3 px-5">
                                <div className="flex flex-col gap-1">
                                    ...
                                    <div className="flex items-center justify-end gap-1">
                                        <span className="text-xs text-secondary-foreground">{message.time}</span>
                                        <CheckCheck
                                            className={cn(
                                                'w-4 h-4',
                ...
                <SheetFooter className="block p-0 sm:space-x-0">
                    <div className="p-4 bg-accent/50 flex gap-2">
                        <Avatar className="size-9">
                            <AvatarImage src={toAbsoluteUrl('/media/avatars//300-14.png')} alt="" />
                            <AvatarFallback>CH</AvatarFallback>
                            <AvatarIndicator className="-end-2 -bottom-2">
                                <AvatarStatus variant="online" className="size-2.5" />
                            </AvatarIndicator>
                        ...
                        <div className="flex-1 flex items-center justify-between gap-0.5">
                            <div className="flex flex-col">
                                <div className="inline-flex gap-0.5 text-sm">
                                    <Link href="#" className="font-semibold text-mono hover:text-primary">
                                        Jane Perez
                                    </Link>
                                    <span className="text-muted-foreground">wants to join chat</span>
                                </div>
                                <span className="text-xs text-muted-foreground">1 day ago • Design Team</span>
                            </div>
