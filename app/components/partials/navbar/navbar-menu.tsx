            ...
            if (item.children) {
                return (
                    <MenubarMenu key={index}>
                        ...
                        <MenubarContent className="min-w-[175px]">{buildSubMenu(item.children)}</MenubarContent>
                    </MenubarMenu>
                );
            } else {
                return (
            ...
            if (item.children) {
                return (
                    <MenubarSub key={index}>
                        ...
                        <MenubarSubContent className="min-w-[175px]">{buildSubMenu(item.children)}</MenubarSubContent>
                    </MenubarSub>
                );
            } else {
                return (
