...
import { ShareProfileSettings, ShareProfileUsers, ShareProfileViaEmail, ShareProfileViaLink } from './';

export function ShareProfileDialog({ open, onOpenChange }: { open: boolean; onOpenChange: () => void }) {
