...
export function ReportUserDialog({ open, onOpenChange }: { open: boolean; onOpenChange: () => void }) {
        ...
        return (
            <div className="grid place-items-center gap-1 px-5">
                ...
                <div className="flex items-center justify-center gap-1">
                    <Link href="#" className="hover:text-primary-active text-sm leading-5 font-semibold text-mono">
                        Jenny Klabber
                    </Link>
    ...
    const buildOptions = () => {
        ...
        return (
            <div className="flex flex-col gap-5 px-5">
                <div className="text-sm text-mono font-semibold">Let us know why you're reporting this person</div>

                <div className="flex flex-col gap-3.5">
                    {items.map((item, index) => (
                        <RadioGroup key={index} value={selectedReason} onValueChange={setSelectedReason}>
