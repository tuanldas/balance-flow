...
export function AccountDeactivatedDialog({ open, onOpenChange }: { open: boolean; onOpenChange: () => void }) {
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="w-full max-w-[500px] max-h-[95%] scrollable-y-auto">
                ...
                <DialogBody className="flex flex-col items-center pt-0 pb-10">
                    ...
                    <h3 className="text-lg font-medium text-mono text-center mb-3">Account Deactivated</h3>
