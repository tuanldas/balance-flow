...
export function WelcomeMessageDialog({ open, onOpenChange }: { open: boolean; onOpenChange: () => void }) {
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-[500px]">
                ...
                <DialogBody className="flex flex-col items-center pt-10 pb-10">
                    ...
                    <h3 className="text-lg font-medium text-mono text-center mb-3">Welcome to Metronic</h3>
                    ...
                    <Link href="/" className="text-sm font-medium text-secondary-foreground hover:text-primary py-3">
                        Skip the tour
                    </Link>
                </DialogBody>
            </DialogContent>
