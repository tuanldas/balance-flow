...
import { ArrowRight, BookOpen, Calendar, Flag, Plus, Thermometer, X } from 'lucide-react';
            ...
            <DialogContent className="sm:max-w-md">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        <h3 className="text-sm font-medium text-muted-foreground">For Sean's Workspace</h3>
