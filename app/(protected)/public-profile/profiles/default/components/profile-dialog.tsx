...
export function ProfileDialog({ open, onOpenChange }: { open: boolean; onOpenChange: () => void }) {
    return (
        <>
            <style>
                {`
            ...
            <Dialog open={open} onOpenChange={onOpenChange}>
                ...
                >
                    <DialogHeader className="modal-rounded-t space-y-0 p-0 border-0 relative min-h-80 flex flex-col items-stretch justify-end bg-center bg-cover bg-no-repeat mb-7 modal-bg">
                                ...
                                <div className="flex items-center flex-col">
                                    ...
                                    <div className="flex flex-wrap justify-center gap-1 lg:gap-3 text-sm">
                                        <div className="flex gap-1 items-center">
                                            <Luggage size={16} className="text-muted-foreground text-base" />
                                            <Link
                                        ...
                                        <div className="flex gap-1 items-center">
                                            <Mail size={16} className="text-muted-foreground text-base" />
                                            <Link
                        ...
                        <Button variant="outline" className="absolute top-5 end-5" onClick={onOpenChange}>
                            <X />
                        </Button>
                    </DialogHeader>
