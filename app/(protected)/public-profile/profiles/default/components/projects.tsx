    ...
    const renderItem = (item: IProjectsItem, index: number) => {
        return (
            <TableRow key={index}>
                ...
                <TableCell>
                    <Progress value={item.progress.value} indicatorClassName={item.progress.variant} className="h-1" />
                </TableCell>
                <TableCell>
                ...
                <TableCell className="text-end text-sm font-medium text-secondary-foreground">{item.dueDate}</TableCell>
