...
import { EllipsisVertical, Luggage, Mail, MapPin, MessagesSquare, Users } from 'lucide-react';
...
export default function ProfileCompanyPage() {
    const image = (
        <div className="flex items-center justify-center rounded-full border-2 border-green-200 size-[100px] shrink-0 bg-background">
            <img src={toAbsoluteUrl('/media/brand-logos/duolingo.svg')} className="size-[50px]" alt="image" />
        </div>
    );
