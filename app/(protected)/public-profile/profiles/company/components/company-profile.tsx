...
import { RemixiconComponentType, RiFacebookCircleLine, RiWhatsappLine, RiYoutubeLine } from '@remixicon/react';
...
const CompanyProfile = () => {
    ...
    return (
        <Card>
            ...
            <CardContent>
                <h3 className="text-base font-semibold text-mono leading-none mb-5">Headquarter</h3>
                ...
                <div className="grid gap-2.5 mb-7">
                    ...
                    <p className="text-sm text-foreground leading-5.5">
                        Now that I’m done thoroughly mangling that vague metaphor, let’s get down to business. You know
                        you need to start blogging to grow your business, but you don’t know how. In this post, I’ll
                        show you how to write a great blog post in five simple steps that people will actually want to
                        read.
                    </p>
                </div>
