...
import { RemixiconComponentType, RiFacebookCircleLine, RiYoutubeLine } from '@remixicon/react';
import { BriefcaseBusiness, Crown, LucideIcon, Luggage, Mail, Volleyball } from 'lucide-react';
    ...
    const renderItem = (item: ISummaryItem, index: number) => {
        return (
            <div key={index} className="flex items-center gap-2.5">
                ...
                <Link href="#" className="text-sm leading-none text-mono hover:text-primary-active">
                    {item.info}
                </Link>
            </div>
        );
        ...
        <Card>
            ...
            <CardContent>
                <p className="text-sm text-foreground leading-5.5 mb-4">
                    Experienced and creative professional with a passion great as for problem-solving and a commitment
                    to excellence.
                </p>
