            ...
            <React.Fragment key={index}>
                <div className="flex flex-col md:flex-row md:items-center gap-5">
                    <div className="flex items-center gap-5 shrink-0">
                        <div className="border border-orange-200 dark:border-orange-950 rounded-lg">
                            <div className="flex items-center justify-center border-b border-orange-200 bg-orange-100 dark:border-orange-950 dark:bg-orange-950/30 rounded-t-lg">
                                <span className="text-sm text-orange-400 fw-medium p-2">{item.month}</span>
                            </div>
                            <div className="flex items-center justify-center size-12">
                                <span className="font-medium text-foreground text-xl tracking-tight">{item.date}</span>
                            </div>
                        </div>
                        <img
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Link href="#" className="text-base font-medium hover:text-primary text-mono leading-4">
                            {item.title}
                        </Link>
                        <p className="text-sm text-foreground leading-[22px]">{item.desc}</p>
                    </div>
                </div>
