        ...
        return (
            <TableRow key={index}>
                <TableCell className="text-start py-2">
                    <Link href="#" className="text-sm font-medium text-mono hover:text-primary">
                        {item.name}
                    </Link>
                </TableCell>
                <TableCell className="text-sm text-foreground">${item.amount}</TableCell>
                <TableCell>
                    <Badge variant={item.color} appearance="light">
                        {item.label}
                    </Badge>
                </TableCell>
                <TableCell className="text-sm text-foreground">{item.date} days</TableCell>
                ...
                <Table className="text-end">
                    <TableHeader>
                        <TableRow className="bg-accent/60">
                            ...
                            <TableHead className="min-w-[100px] text-secondary-foreground! h-10">Amount</TableHead>
                            <TableHead className="min-w-[100px] text-secondary-foreground! h-10">Status</TableHead>
                            <TableHead className="min-w-[110px] text-secondary-foreground! h-10">Duration</TableHead>
