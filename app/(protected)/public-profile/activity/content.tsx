    ...
    return (
        <div className="flex gap-5 lg:gap-7.5">
            {years.map((year, index) => (
                <Card key={index} className={`grow ${year === currentYear ? '' : 'hidden'}`} id={`activity_${year}`}>
                    <CardHeader>
                    ...
                    <CardContent>
                        {(year === 2025 || year === 2023 || year === 2022) && <ActivitiesNewArticle />}
                        {(year === 2025 || year === 2022) && <ActivitiesInterview />}
                        {(year === 2025 || year === 2021) && <ActivitiesPhotographyWorkshop />}
