        ...
        <Fragment>
            <Card className="p-8 lg:p-12">
                <CardContent>
                    ...
                    <div className="text-lg font-medium text-mono text-center">Upload Item to Get Started</div>
                    <div className="text-sm text-secondary-foreground text-center gap-1">
                        Begin by crafting your inaugural list in minutes.&nbsp;
                        <Link href="/account/billing/plans" className="text-sm font-medium link">
                            Get Started!
                        </Link>
                    </div>
                </CardContent>
            ...
            <div className="flex grow justify-center pt-5 lg:pt-7.5">
                <Button mode="link" underlined="dashed" asChild>
                    <Link href="/public-profile/profiles/default">Check ready Templates</Link>
                </Button>
            </div>
        </Fragment>
    );
