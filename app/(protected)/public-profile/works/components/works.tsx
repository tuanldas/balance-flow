...
import { Offer } from '@/app/(protected)/public-profile/works/cards/offer';
import { OfferRow } from '@/app/(protected)/public-profile/works/cards/offer-row';
    ...
    return (
        <div className="flex flex-col items-stretch gap-5 lg:gap-7.5">
            <div className="flex flex-wrap items-center gap-5 justify-between">
                <h3 className="text-lg text-mono font-semibold">{items.length} Works</h3>
                <ToggleGroup
                    type="single"
                    variant="outline"
                    value={activeView}
                ...
                <div id="works_cards">
                    ...
                    <div className="flex grow justify-center pt-5 lg:pt-7.5">
                        <Button mode="link" underlined="dashed" asChild>
                            <Link href="#">Show more works</Link>
                        </Button>
                    </div>
                </div>
            )}
