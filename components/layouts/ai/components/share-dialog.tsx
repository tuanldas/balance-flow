            ...
            <DialogContent>
                ...
                <div className="bg-background p-6 space-y-4">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Share this chat session with others</p>
                    </div>
                    ...
                    <div className="grid grid-cols-4 gap-4">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                ...
                                >
                                    <svg viewBox="0 0 1200 1227" className="size-6 text-foreground fill-current">
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                ...
                                >
                                    <svg viewBox="0 0 32 32" className="size-6 text-foreground fill-current">
                                        <path
                                            fillRule="evenodd"
                                            clipRule="evenodd"
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                ...
                                >
                                    <svg viewBox="0 0 24 24" className="size-6 text-foreground fill-current">
