...
const NewChatContext = createContext<NewChatContextValue | undefined>(undefined);
...
export function NewChatProvider({ children }: NewChatProviderProps) {
    ...
    return <NewChatContext.Provider value={{ requestId, startNewChat }}>{children}</NewChatContext.Provider>;
}
