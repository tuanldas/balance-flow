...
import { Bell, Calendar, CheckSquare, Clock, Settings, Users } from 'lucide-react';
...
export function SidebarCalendarMenu() {
    ...
    return (
        <div className="px-4 space-y-3.5 pt-6">
            <div className="text-[0.725rem] font-medium text-muted-foreground tracking-wider uppercase">Calendars</div>
                ...
                {menuItems.map((item) => (
                    <button
                        ...
                        className={cn(
                            ...
                            activeItem === item.id ? 'bg-white/10 shadow-sm' : 'bg-transparent',
                        )}
                    >
                            ...
                            {item.count !== undefined && (
                                <span
                                    className={cn(
                                        ...
                                        activeItem === item.id ? 'bg-white/20 text-white' : 'bg-white/5 text-gray-400',
                                    )}
                                >
                                    {item.count}
                                </span>
