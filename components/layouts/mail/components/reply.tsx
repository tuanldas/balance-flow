...
export function Reply({ onOpenChange, mode = 'reply' }: ReplyProps) {
    ...
    const [emailChips, setEmailChips] = useState<
        Array<{ id: string; email: string; logo: string; logoUrl?: string; avatarUrl?: string }>
    >([]);
        ...
        <>
            <div className="border bg-background mx-4 rounded-lg">
                ...
                <div className="flex items-center justify-between p-4 bg-background rounded-b-lg">
                                    ...
                                    toast.custom(
                                        (t) => (
                                            <Alert variant="mono" icon="success" onClose={() => toast.dismiss(t)}>
                                                ...
                                                <AlertTitle>Email sent to {emailAddress || ''}</AlertTitle>
                                            </Alert>
                                        ),
                                        {
                                            duration: 3000,
                                    ...
                                    toast.custom(
                                        (t) => (
                                            <Alert variant="mono" icon="success" onClose={() => toast.dismiss(t)}>
                                                ...
                                                <AlertTitle>Please write a message before sending</AlertTitle>
                                            </Alert>
                                        ),
                                        {
                                            duration: 3000,
                    ...
                    <Button variant="outline" onClick={generateEmailContent} disabled={isGenerating}>
