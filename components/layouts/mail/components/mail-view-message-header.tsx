...
import { BellDot, Download, Folder, MoreHorizontal, Printer } from 'lucide-react';
    ...
    return (
        <TooltipProvider>
            <div className="px-4 mb-2">
                <span className="text-lg text-foreground text-semibold">{email.subject}</span>
                            ...
                            <HoverCardContent className="w-fit min-w-82 max-w-96">
                                <div className="flex items-center gap-2.5">
                                    ...
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <span className="text-2sm text-muted-foreground">
                                            {email.sender} &lt;no-reply@{email.sender.toLowerCase()}.com
                                        </span>
